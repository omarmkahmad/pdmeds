...
export const TIPS = {
  ...
  level: `Modeled plasma levodopa on a relative scale. 100 = the peak after one 100 mg IR dose taken on its own (for example, one Sinemet 25/100). Real levels vary a lot with meals, gastric emptying, and disease stage. ${LEVEL_ANCHOR_SENTENCE}`,
